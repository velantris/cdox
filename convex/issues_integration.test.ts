        ...
        test("should have proper data structure relationships", () => {
            ...
            const mockAnalysis = {
                ...
                providerRaw: {
                    ...
                    language_complexity: {
                        cefrLevel: "B2",
                        b2ComplianceScore: 78.5,
                        plainLanguageScore: 82.1,
                        readabilityAdjusted: 9.4,
                        ...
                        vocabularyComplexity: {
                            ...
                            simpleWordPercentage: 74.5,
                            advancedWordPercentage: 25.5,
                            complexWordPercentage: 16.2,
                            jargonCount: 4,
                            jargonTerms: ["provision", "liability"],
                            advancedSample: ["liability", "jurisdiction"],
                        },
                        sentenceComplexity: {
                            sentenceCount: 80,
                            averageSentenceLength: 18.5,
                            complexSentencePercentage: 28.3,
                            subordinateClauseDensity: 0.6,
                            passiveVoicePercentage: 18.4,
                            modalVerbPercentage: 6.5,
                            conditionalSentencePercentage: 4.2,
                        },
                        plainLanguageRecommendations: ["Reduce jargon in fee disclosures."],
                    },
                },
                createdAt: Date.now(),
            };
